  ...
  return (
    ...
    <section className='flex flex-row justify-center items-center !-mt-2'>
        <div className='fronttext1 md:!pt-4 md:!pb-0 md:!pl-6 md:!pr-6 min-w-[70%] lg:max-w-[70%] flex flex-col gap-10 justify-center items-center'>
            ...
            <div className='!mt-4 lg:!mt-10 !p-1 bg-gradient-to-r from-yellow-400 to-pink-500 rounded-full'>
                <img
                  src="/fallbackimage.jpg"
                  alt="Blog post thumbnail"
                  className='w-[300px] h-[300px] xl:w-[350px] xl:h-[350px] object-cover rounded-full'
                />
            </div>
