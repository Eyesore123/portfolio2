...
export default function Githubandcvs() {
    ...
    const downloadUrls = {
        en: {
            cv: '/CVs/CV_Joni_Putkinen_english.pdf',
            cvIt: '/CVs/CV_Joni_Putkinen_IT_english.pdf'
        },
        fi: {
            cv: '/CVs/CV_Joni_Putkinen_finnish.pdf',
            cvIt: '/CVs/CV_Joni_Putkinen_IT_finnish.pdf'
        }
    };
                ...
                <div className='splitcontainer grid grid-cols-2 gap-20 md:gap-0 min-h-60 w-[50%] lg:max-w-[50%]'>
                    ...
                    <div className='cvcontainer flex flex-col justify-center items-center'>
                        ...
                        <div className='flex flex-col justify-center items-center'>
                            ...
                            <a href={downloadUrls[language].cv} download>
                            ...
                            <a href={downloadUrls[language].cvIt} download>
                                <button className='btn btn-primary !m-6'>{t("home.downloadbutton")}</button>
                            </a>
                        </div>
                    </div>
