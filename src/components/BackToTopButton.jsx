...
export default function BackToTopButton() {
  ...
  const scrollToTop = () => {
    setHovered(false); // 👈 Reset hover state on click
  ...
  return (
    <button
      ...
      className={`
        fixed bottom-4 md:bottom-6 right-3 md:right-6 !z-50 flex items-center
        !bg-pink-500 !text-white !rounded-md !shadow-lg
