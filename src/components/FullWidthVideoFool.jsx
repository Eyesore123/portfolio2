...
export default function FullWidthVideoFool() {
  ...
  return (
    <section className="w-screen h-90 md:h-[500px] lg:h-[1050px] 3xl:h-[1700px] customheight overflow-hidden relative !mx-0 !px-0">
      ...
      >
        ...
        <div className="flex !gap-4 !mt-3 md:!mt-4 justify-center lg:justify-start">
          <button
            onClick={togglePlay}
            className="!p-2 md:!p-3 rounded-full bg-white/70 hover:bg-white text-black shadow transition-colors hover:cursor-pointer"
