  ...
  return (
    <section className="flex flex-row justify-center items-center !mt-10 !mb-10 xl:!mb-0 xl:!pb-0 xl:!mt-0">
      <div className="w-[95%] lg:max-w-[100%] flex flex-col justify-center items-center">
        <h2 className="gradienttext flex flex-row justify-center items-center !mb-24 xl:!mb-10 xl:!mt-10">
          {t('showcase.header')}
        </h2>
        <div className="flex flex-col md:flex-row justify-center items-center w-full gap-12 xl:gap-16 !mb-10 xl:!mb-0 xl:scale-80">
          {/* Print Ad Image */}
          <div className="flex flex-col items-center">
            <img
              src="/mainos.jpg"
              alt={t('showcase.printAdAlt')}
              className="rounded-xl shadow-lg !max-w-[240px] md:!min-w-[250px] !md:max-w-[300px] !lg:max-w-[480px] lg:!min-w-[400px]"
              loading="lazy"
            />
          </div>
            ...
            {/* Arrow Placeholder */}
          <div className="flex flex-col items-center">
            <span className="text-4xl md:text-7xl text-[#ffc600] !xl:w-40">
          ...
          <div className="flex flex-col items-center relative max-w-[240px] min-w-[180px] md:max-w-[260px] lg:!max-w-[280px] w-full">
