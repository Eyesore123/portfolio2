...
export default function ProjectCards() {
  ...
  return (
    <>
      <div className="grid md:grid-cols-2 gap-8 px-4 py-10 md:!mx-20 lg:!mx-50">
        {projectData.map((project) => (
          <div key={project.name} className="p-[1px] rounded-xl bg-gradient-to-r from-[#5800ff] to-[#e900ff] md:max-w-140">
