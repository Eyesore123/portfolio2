  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed bottom-4 md:bottom-6 left-3 md:left-6 !z-40 
             bg-[#E900FF] text-white 
             !px-4 !py-2 md:!py-3 rounded-lg shadow-md border-none 
             hover:opacity-80 hover:cursor-pointer 
             transition flex items-center gap-2"
      >
        🍪 <span className="hidden sm:inline">{t('cookieConsent.settings')}</span>
      </button>
        ...
        <div className="cookiediv fixed bottom-0 left-0 right-0 bg-black text-white !p-6 
          ...
          <div className="flex flex-col md:flex-row !space-y-2 md:!space-y-0 md:!space-x-3">
            <button
              ...
              className="bg-[#5800FF] hover:bg-[#5800FF]/80 text-white !px-4 !py-2 rounded shadow-md transition-colors hover:cursor-pointer"
            >
              {t('cookieConsent.accept')}
            </button>
            <button
              onClick={() => saveConsent({ necessary: true, optional: false })}
              className="bg-[#E900FF] hover:bg-[#E900FF]/80 text-white !px-4 !py-2 rounded shadow-md transition-colors hover:cursor-pointer"
            >
